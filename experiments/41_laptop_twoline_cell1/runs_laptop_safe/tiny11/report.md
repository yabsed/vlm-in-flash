...
|---:|:---:|---:|---:|---:|---:|---:|---:|
| 0.50 | ABS | 0.976 ms | 0.956 ms | 2.059% | 0.0010 ms | -0.0230 ms | 0.14 |
| 0.50 | X2 | 0.929 ms | 0.935 ms | -0.605% | 0.0028 ms | 0.0021 ms | 0.05 |
| 0.45 | ABS | 1.043 ms | 1.039 ms | 0.379% | -0.0017 ms | -0.0026 ms | 0.01 |
| 0.45 | X2 | 1.016 ms | 1.019 ms | -0.310% | 0.0029 ms | -0.0000 ms | 0.01 |
| 0.42 | ABS | 1.127 ms | 1.131 ms | -0.402% | -0.0018 ms | 0.0059 ms | -0.00 |
| 0.42 | X2 | 1.087 ms | 1.085 ms | 0.223% | 0.0026 ms | -0.0047 ms | 0.00 |
| 0.40 | ABS | 1.197 ms | 1.201 ms | -0.315% | -0.0016 ms | 0.0050 ms | -0.00 |
| 0.40 | X2 | 1.162 ms | 1.153 ms | 0.733% | 0.0006 ms | -0.0086 ms | 0.01 |
| 0.35 | ABS | 1.357 ms | 1.352 ms | 0.358% | -0.0009 ms | -0.0043 ms | 0.00 |
| 0.35 | X2 | 1.305 ms | 1.313 ms | -0.615% | 0.0038 ms | 0.0041 ms | 0.01 |
| 0.30 | ABS | 1.478 ms | 1.477 ms | 0.099% | 0.0017 ms | -0.0031 ms | 0.00 |
| 0.30 | X2 | 1.424 ms | 1.443 ms | -1.323% | 0.0032 ms | 0.0159 ms | 0.00 |
| 0.25 | ABS | 1.555 ms | 1.553 ms | 0.129% | 0.0019 ms | -0.0036 ms | 0.01 |
| 0.25 | X2 | 1.566 ms | 1.576 ms | -0.641% | 0.0073 ms | 0.0027 ms | 0.01 |
| 0.20 | ABS | 1.712 ms | 1.709 ms | 0.155% | -0.0018 ms | -0.0006 ms | 0.00 |
| 0.20 | X2 | 1.718 ms | 1.713 ms | 0.248% | 0.0024 ms | -0.0066 ms | 0.02 |
| 0.15 | ABS | 1.836 ms | 1.833 ms | 0.189% | -0.0023 ms | -0.0012 ms | 0.00 |
| 0.15 | X2 | 1.824 ms | 1.819 ms | 0.270% | 0.0062 ms | -0.0112 ms | 0.00 |

## 같은 R에서 마스크가 얼마나 바뀌었나

| score | cases | same mask | mean error Δ | mean |error Δ| | total Δ | selector Δ | SSD Δ | chunk Δ |
|:---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ABS | 1134 | 77.95% | -0.001690 | 0.001884 | -0.0012 ms | -0.0005 ms | -0.0006 ms | +0.035 |
| X2 | 1134 | 75.31% | -0.001468 | 0.001682 | +0.0035 ms | +0.0027 ms | +0.0009 ms | +0.033 |

## 판정

2-line의 동일-error 평균 gain은 ABS `+0.295%`, X² `-0.224%`이며, ceiling 승수는 `{'abs:2-line': 7, 'x2:lookup': 5, 'abs:lookup': 2, 'x2:2-line': 4}`다. 같은 R의 마스크 일치율은 두 score 평균 `76.63%`다.
...
![SSD fit](tiny11/twoline_fit.png)

![Frontier](tiny11/lookup_vs_twoline_frontier.png)

![Gain](tiny11/twoline_gain.png)

![Components](tiny11/twoline_components.png)
